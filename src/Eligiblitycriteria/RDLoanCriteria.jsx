...
const RDLoanCriteria = () => {
  ...
  const handleNext = () => navigate("/PersonalProfile/rd");
          ...
          <Grid item xs={12} md={6}>
            <motion.div initial="hidden" animate="visible" variants={containerVariants}>
              ...
              <Typography variant="h6" sx={{
                ...
                Eligibility criteria for research project financing
              </Typography>
            ...
            <motion.div initial="hidden" animate="visible" variants={containerVariants}>
              <Card sx={{
                ...
                <CardContent sx={{ p: 4 }}>
                  ...
                  <List>
                    {[
                      { icon: <Science />, text: 'Approved research proposal' },
                      { icon: <Biotech />, text: 'Institutional affiliation' },
                      { icon: <School />, text: 'Postgraduate qualification' }
                    ].map((item, index) => (
